...
* Know the status of last message send in chat with focus; Control + shift + e.
...
### Virtual view of chats:
This function is experimental, so, is possible that can remove in next updates.
The principal function is load and navigate arrant a chat list for move without check the messages like read.
Unfortunately, the application does not have a logic order for the conversations, for this reason do not exist a consonant order of navigation. And only have shown the chats display on screen to the moment of refresh the list.
The commands of this function are the following:

* Shift + f5: refresh the chat list.
* Shift +u p arrow; say the previous chat.
* Shift + down arrow; say the next chat.
* Shift + enter; focus the read chat.
